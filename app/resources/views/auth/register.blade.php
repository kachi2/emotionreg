                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    <ul class="nav-border nav nav-pills" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#LogIn_Tab" role="tab">Register</a>
                                        </li>
                                    </ul>
                                     <!-- Tab panes -->
                                        ...
                                        <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">                                        
                                            ...
                                            <div class="form-group mb-2">
                                                    ...
                                                    <div class="input-group">                                                                                         
                                                        <input type="text" class="form-control" name="name" id="username" placeholder="Enter Full Name">
                                                    </div>                                    
                                                </div><!--end form-group--> 
                                                <div class="form-group mb-2">
                                                ...
                                                <div class="form-group mb-0 row">
                                                    <div class="col-12">
                                                        ...
                                                        <a href="{{route('login')}}" class="p-2 btn"> Login Here</a>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->                           
                                            </form><!--end form-->
                                        </div>
